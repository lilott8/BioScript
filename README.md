...
Also, if [BioScriptGrammar](https://github.com/lilott8/BioScriptGrammar "BioScript's Grammar") is updated, you'll need to run `git submodule update --init --recursive` if your version of git does not do this automatically for you.
